...
class UserBookStats extends React.Component {
  renderTime = (date) => {
    //转换unix时间戳至指定格式
  ...
  render() {
    ...
    return (
      <div className="userorder-table mt-4">
        <div className="userorder-table mt-4">
          <Navbar />
          ...
          {/*<Divider/>*/}
          <div>
            <div style={{ fontSize: 20, float: "left" }}>Total books bought：</div>
            {/* <div
              className="statsprice-container"
              style={{ marginLeft: 10, float: "left" }}
            >
              {this.state.total_amount}
            </div> */}
            <div style={{ fontSize: 20, marginLeft: 10, marginTop: 5 }}>{this.state.total_amount}</div>
          </div>
          <div style={{ marginTop: 20 }}>
            <div style={{ fontSize: 20, marginTop: 5, float: "left" }}>
              Total paid：￥{this.state.total_price
